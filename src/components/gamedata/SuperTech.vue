<template>
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>超级工厂科技</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <el-card>
        ...
        <el-row style="margin-top: 20px">
          ...
          <el-table :data="dataList" stripe border>
            ...
            <el-table-column prop="techId" label="科技点ID" align="center"></el-table-column>
            <el-table-column prop="techName" label="科技点名称" align="center"></el-table-column>
  ...
  export default {
    ...
    methods : {
      ...
      async queryData(){
        ...
        const {data : res} = await this.$http.post("/gm/game/data/super/tech",param)
        if(res.meta.status !== 200){
