      ...
      <el-card>
        ...
        <el-row style="margin-top: 20px">
          ...
          <el-table :data="dataList" stripe border>
            ...
            <el-table-column prop="total" label="投资总次数" align="center"></el-table-column>
            <el-table-column prop="avgTotal" label="人均投资总次数" align="center"></el-table-column>

            <el-table-column prop="green" label="绿色次数" align="center"></el-table-column>
            <el-table-column prop="blue" label="蓝色次数" align="center"></el-table-column>
            <el-table-column prop="purple" label="紫色次数" align="center"></el-table-column>
            <el-table-column prop="orange" label="橙色次数" align="center"></el-table-column>
            <el-table-column prop="red" label="红色次数" align="center"></el-table-column>

            <el-table-column prop="united" label="联合次数" align="center"></el-table-column>
            <el-table-column prop="avgUnited" label="人均联合次数" align="center"></el-table-column>
  ...
  export default {
    ...
    methods : {
      ...
      async queryData(){
        ...
        const {data : res} = await this.$http.post("/gm/game/data/investment",param)
        if(res.meta.status !== 200){
