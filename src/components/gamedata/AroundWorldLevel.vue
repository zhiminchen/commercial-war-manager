<template>
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>环游世界等级</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <el-card>
        ...
        <el-row style="margin-top: 20px">
          ...
          <el-table :data="dataList" stripe border>
            ...
            <el-table-column prop="level" label="线路等级" align="center"></el-table-column>
            <el-table-column prop="count1" label="人数1" align="center"></el-table-column>
            <el-table-column prop="count2" label="人数2" align="center"></el-table-column>
            <el-table-column prop="count3" label="人数3" align="center"></el-table-column>
            <el-table-column prop="count4" label="人数4" align="center"></el-table-column>
            <el-table-column prop="count5" label="人数5" align="center"></el-table-column>
  ...
  export default {
    ...
    methods : {
      ...
      async queryData(){
        ...
        const {data : res} = await this.$http.post("/gm/game/data/around/level",param)
        if(res.meta.status !== 200){
