<template>
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>区服数据</el-breadcrumb-item>
      </el-breadcrumb>

      <el-card>
        <el-row>
          <el-col :span="4" style="margin-right: 20px">
            <el-select v-model="selectGameBegin" placeholder="请选择开始游戏服务器">
              <el-option
          ...
          <el-col :span="4" style="margin-right: 20px">
            <el-select v-model="selectGameEnd" placeholder="请选择结束游戏服务器">
              <el-option
                v-for="item in gameConfigList"
                :key="item.id"
                :label="item.name"
  ...
  export default {
    ...
    methods : {
      ...
      async queryData(){
        ...
        if(!this.selectGameBegin){
          return this.$message.error("选择起始服务器")
        }

        if(!this.selectGameEnd){
          return this.$message.error("选择结束服务器")
        }
        ...
        let param = {
          startServerId : this.selectGameBegin ,
          endServerId: this.selectGameEnd,
