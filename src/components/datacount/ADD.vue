<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>新增用户列表</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card>
      ...
      <el-table :data="dataList" border stripe>
        ...
        <el-table-column prop="count" label="新增人数"  align="center"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async queryData() {
        ...
        const {data : res} = await this.$http.post('/gm/ad/add' , param)
        if(res.meta.status !== 200){
